    ...
    return (
        <div className='my-4 py-[50px] md:p1-[120px] px-5 md:flex justify-between'>
            <div className='md:w-[40%]'>
                ...
                <div className='mx-auto mb-4 text-sm w-[70%] mt-6 pl-7'>By clicking Continue to join or sign in , you agree to our <span className='text-blue-800 cursor-pointer hover:underline'>AcadLinker's User Agreement</span>.<span className='text-blue-800 cursor-pointer hover:underline'>Privacy Policy</span> , and <span className='text-blue-800 cursor-pointer hover:underline'>Cookie Policy</span>.</div>
